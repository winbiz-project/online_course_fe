...
import { Button, Text, Divider, Flex, Image, Link, Spacer, Stack, IconButton, SimpleGrid, Center, Input, InputGroup, InputRightElement } from "@chakra-ui/react";
...
export default function RegisterGoogle() {
  ...
  const handleSubmit = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      registerUser(googleAccount.name , googleAccount.email, password, confirmPassword,navigate)
    }
  };
